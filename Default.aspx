        ...
        <div class="row">
          ...
          <div class="span4">
            ...
            <div class="inside">
              ...
              <div class="entry-content">
                <p></p>
                <a class="more-link" href="http://www.grovelimited.com/index.html" target="_blank">view project</a> </div>
            </div>
            <!-- /.inside -->
          </div>
          ...
          <div class="span4">
            ...
            <div class="inside">
              ...
              <div class="entry-content">
                <p></p>
                <a class="more-link" href="#" target="_blank">view project</a> </div>
            </div>
            <!-- /.inside -->
          </div>
          <!-- /.span4 -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="span3">
            ...
            <h2>Web design</h2>
            <p>Interested in creating an awesome looking website, you've come to the right place. I can design a web site specific to your wants and needs. Just let me know what you would like and I would be your personal designer and offer you a complete web development service and hosting to get you on the World Wide Web fast! </p>
          </div>
          <!-- /.span3 -->
          <div class="span3">
            <div class="align"> <i class="icon-vector sev_icon"></i> </div>
            <h2>Logo Design</h2>
            <p>With an eye towards attractive design, customer friendly sites, I offer both custom web site and print graphics for your company. My logo design services offers everything from custom company logos and stationary, web graphics , and digital enhanced photographs. My hands on approach will insure that you get the custom graphic designs that will fit your business needs.</p>
          </div>
          <!-- /.span3 -->
          <div class="span3">
            <div class="align"> <i class="icon-basket sev_icon"></i> </div>
            <h2>Web Development</h2>
            <p>I have refined my web development process to ensure that clients and users can enjoy gorgeous sites that function well on any device. Every site that I develop is programmed using the latest HTML 5 and CSS3 standards, bootstrap 3.0, JQuery and Javascript. Site development using open source content management systems like Wordpress. </p>
          </div>
          <!-- /.span3 -->
        ...
        <div class="row">
          <div class="span12">
            <div class="cform" id="theme-form">
              <form id="Form1" action="#" method="post" class="cform-form" runat="server">
                <div class="row">
